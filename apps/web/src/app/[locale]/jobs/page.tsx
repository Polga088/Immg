  ...
  return (
    <Suspense>
      ...
      connectionsLabels={{
        ...
        connectGmail: t("connections.connectGmail"),
        connecting: t("connections.connecting"),
        ...
        gmailEmail: t("connections.gmailEmail"),
        appPassword: t("connections.appPassword"),
        appPasswordHint: t("connections.appPasswordHint"),
        appPasswordHelp: t("connections.appPasswordHelp"),
        connectFailed: t("connections.connectFailed"),
        invalidCredentials: t("connections.invalidCredentials"),
        syncFailed: t("connections.syncFailed"),
        connectSuccess: t("connections.connectSuccess"),
      }}
      opportunitiesLabels={{
